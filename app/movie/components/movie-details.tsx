...
import MovieGenres from "@/app/movie/components/movie-genres";
...
const MovieDetails = ({ movie }: MovieDetailsProps) => {
  return (
    <div className="to-primary from-secondary absolute bottom-0 flex aspect-square w-full flex-col items-center justify-center gap-5 rounded-t-[56px] bg-gradient-to-r md:relative md:aspect-auto md:items-start md:rounded-none md:bg-none">
      <div className="flex flex-col items-center gap-2.5 md:flex-row">
        ...
        <h2 className="order-1 text-3xl font-bold md:order-[-1]">
